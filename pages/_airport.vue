  ...
  <div>
    ...
    <section v-if="reviews && reviews.length > 3" id="reviews" class="pt-10 pb-24 overflow-hidden">
      ...
      <section class="relative mb-16">
        <div class="container mx-auto">
          <Review :review="reviews[0]" style="width: calc(50% - 470px); left: -150px"
          ...
          <Review :review="reviews[3]" style="width: calc(50% - 470px); right: -150px"
                  class="absolute top-0 hidden xl:block opacity-50"/>
        </div>
      </section>
    </section>
    ...
    <section id="map" class="bg-gray-200 border-t border-b border-gray-500 py-24">
      <div class="container mx-auto">
        ...
        <p>
          ...
          class="text-blue-700 hover:text-blue-900 hover:underline">{{ $i18n('reservation.directions-to', {
