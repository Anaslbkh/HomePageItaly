...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileColor', content: '#0983F0' },
      {
        ...
        content: 'https://assets.parkos.com/assets/favicon/ms-icon-144x144.png'
      },
      {
        name: 'msapplication-TileConfig',
        content: 'https://assets.parkos.com/assets/favicon/browserconfig.xml'
      }
    ],
    link: [
      {
        rel: 'icon',
        type: 'image/x-icon',
        href: 'https://assets.parkos.com/assets/favicon/favicon.ico'
      },
      {
        rel: 'apple-touch-icon',
        href: 'https://assets.parkos.com/assets/favicon/apple-icon.png'
      },
      {
        rel: 'apple-touch-icon',
        sizes: '57x57',
        href: 'https://assets.parkos.com/assets/favicon/apple-icon-57x57.png'
      },
      {
        rel: 'apple-touch-icon',
        sizes: '60x60',
        href: 'https://assets.parkos.com/assets/favicon/apple-icon-60x60.png'
      },
      {
        rel: 'apple-touch-icon',
        sizes: '72x72',
        href: 'https://assets.parkos.com/assets/favicon/apple-icon-72x72.png'
      },
      {
        rel: 'apple-touch-icon',
        sizes: '76x76',
        href: 'https://assets.parkos.com/assets/favicon/apple-icon-76x76.png'
      },
      {
        rel: 'apple-touch-icon',
        sizes: '114x114',
      ...
      },
      {
        ...
        sizes: '192x192',
        href:
          'https://assets.parkos.com/assets/favicon/android-icon-192x192.png'
      },
  ...
  modules: ['@nuxtjs/axios', '@nuxtjs/sentry', '@dansmaculotte/nuxt-zendesk'],
